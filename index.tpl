...
</head><body style="color:rgba(255,255,255,0.9);background:#3d84a8;display:flex;flex-direction:column;align-items:center;justify-content:center;height:90vw;font-family:Arial;text-align:center;">
<style>
...
//	fetch( pairing ).then( response => console.log( response ) )
	...
	Object.entries( languages ).forEach( o => {
		lhtml += ' <a href="' + ( location.origin == "null" ? "" : location.origin ) + "/" + o[ 1 ] + "?instruct" + pairing_code + '">' + o[ 0 ] + '</a> '
	} )
